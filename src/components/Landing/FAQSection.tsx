...
export default function FAQSection(): React.JSX.Element {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "هر کسب‌وکاری که با نوبت‌دهی سر و کار دارد! از سالن‌های زیبایی و کلینیک‌های پزشکی گرفته تا مشاوران، وکلای دادگستری، مجموعه‌های ورزشی، آموزشگاه‌ها و حتی تعمیرگاه‌ها می‌توانند از مدیریت هوشمند آنتایم برای نظم‌دهی به بیزینس خود استفاده کنند.",
