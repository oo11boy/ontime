  ...
  const faqs = [
    {
      ...
      answer:
        "خیر، یکی از بزرگترین مزایای آنتایم همین است! مشتری شما هیچ نیازی به نصب برنامه ندارد. تمام تعاملات شامل مشاهده نوبت، یادآوری و لینک تغییر زمان از طریق پیامک و وب‌اپلیکیشن (PWA) انجام می‌شود که روی تمام گوشی‌ها به سرعت باز می‌شود.",
      icon: <Zap className="text-amber-500" size={20} />,
    },
    {
      question: "هزینه پیامک‌های یادآوری چگونه محاسبه می‌شود؟",
      answer:
        "ما با معتبرترین سرورهای پیامکی کشور متصل هستیم تا نرخ رسیدن پیامک (Delivery) نزدیک به ۱۰۰٪ باشد. شما بر اساس پلن انتخابی خود، ماهانه تعدادی پیامک هدیه دریافت می‌کنید و در صورت نیاز به پیامک بیشتر، می‌توانید پنل خود را با تعرفه رسمی شارژ کنید.",
      icon: <MessageCircle className="text-blue-500" size={20} />,
    },
    {
      question: "سیستم چگونه از کنسلی نوبت‌ها جلوگیری می‌کند؟",
      answer:
        "آنتایم با ارسال پیامک‌های هوشمند در بازه‌های زمانی مشخص، نوبت را به مشتری یادآوری می‌کند. همچنین با ارائه لینک اختصاصی، به مشتری اجازه می‌دهد طبق قوانین شما (مثلاً تا ۲۴ ساعت قبل) نوبت را جابجا کند، که این کار از خالی ماندن تایم شما جلوگیری می‌کند.",
      icon: <HelpCircle className="text-indigo-500" size={20} />,
    },
    {
      question: "آیا امنیت داده‌ها و لیست مشتریان من تضمین شده است؟",
      answer:
        "قطعا. امنیت اولویت اول ماست. اطلاعات شما و مشتریانتان به صورت رمزنگاری شده در سرورهای ابری اختصاصی آنتایم نگهداری می‌شود. شما مالک کامل داده‌ها هستید و هر زمان که بخواهید می‌توانید از لیست نوبت‌ها و مشتریان خود خروجی اکسل تهیه کنید.",
      icon: <ShieldCheck className="text-emerald-500" size={20} />,
    },
    {
      question: "آنتایم برای چه کسب‌وکارهایی مناسب است؟",
      answer:
        "هر کسب‌وککاری که با نوبت‌دهی سر و کار دارد! از سالن‌های زیبایی و کلینیک‌های پزشکی گرفته تا مشاوران، وکلای دادگستری، مجموعه‌های ورزشی، آموزشگاه‌ها و حتی تعمیرگاه‌ها می‌توانند از مدیریت هوشمند آنتایم برای نظم‌دهی به بیزینس خود استفاده کنند.",
      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-600 font-medium leading-relaxed">
            پاسخ تمام سوالاتی که برای شروع <strong>نوبت‌دهی آنلاین</strong> در
            ذهن دارید.
          </p>
        </div>
            ...
            >
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <h3
                    className={`text-base lg:text-lg font-black transition-colors ${
        ...
        <div className="mt-20 relative overflow-hidden bg-white p-10 rounded-[3rem] border border-slate-200 shadow-2xl flex flex-col items-center group">
          ...
          <div className="mt-6 flex items-center gap-2 text-slate-600 text-sm font-bold">
