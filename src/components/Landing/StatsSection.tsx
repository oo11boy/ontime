    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <h2 id="stats-heading" className="text-2xl lg:text-3xl font-black text-slate-800 mb-4">
            چرا آنتایم انتخاب اول <span className="text-blue-600">کسب‌وکارهای هوشمند</span> است؟
          </h2>
          <p className="text-slate-500 font-medium">آمار موفقیت سیستم نوبت‌دهی ما در سال ۲۰۲۵</p>
        </div>
...
/>
      ...
      <div className="relative z-10">
        ...
        <p className="text-[11px] font-bold text-slate-400 group-hover:text-blue-500 transition-colors">
          {description}
        </p>
      </div>
    </div>
