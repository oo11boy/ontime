        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-right">
            ...
            <p className="text-lg text-slate-600 mb-10 font-medium leading-relaxed">
              با <strong>پنل مدیریتی آنتایم</strong>، فراتر از یک تقویم ساده
              بروید. مشتریان وفادار خود را بشناسید، نرخ کنسلی را مانیتور کنید و
              برای افزایش درآمد صنف خود تصمیمات مبتنی بر داده بگیرید.
            </p>
            ...
            <div className="space-y-4">
              {[
                ...
                <div
                  key={index}
                  className="flex gap-4 p-6 bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow"
                >
                  <div className="shrink-0 w-12 h-12 bg-slate-50 rounded-2xl flex items-center justify-center border border-slate-100">
                    {item.icon}
                  </div>
                  <div>
                    <h3 className="font-black text-slate-900 mb-1 text-base">
                      {item.title}
                    </h3>
            ...
            <div className="relative bg-white rounded-[3rem] p-8 border border-slate-200 shadow-2xl shadow-blue-100/50">
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="p-5 bg-linear-to-br from-slate-50 to-white rounded-4xl border border-slate-100 shadow-sm">
                  <div className="text-blue-600 text-3xl font-black mb-1">
                    ۱۲۴
                  </div>
              ...
              <div className="space-y-3">
                ...
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-center justify-between p-4 bg-slate-50/50 rounded-2xl border border-slate-100 hover:bg-white hover:shadow-md transition-all duration-300"
                  >
                    <div className="flex items-center gap-3">
                    ...
                    <div className="flex gap-3 items-center">
                      <span
                        className={`text-[9px] px-2.5 py-1 rounded-lg font-black shadow-sm ${user.color}`}
                      >
                        {user.status}
                      </span>
                      {user.cancel && (
              ...
              {/* فوتر نمایشی پنل */}
              <div className="mt-8 pt-6 border-t border-slate-100 flex justify-center text-xs text-slate-600 font-bold gap-2 items-center italic">
                <Users size={14} />
