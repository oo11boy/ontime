...
export default function HeroSection() {
  return (
    <article>
      <section
        className="relative py-16 lg:py-28 overflow-hidden bg-white"
        dir="rtl"
      >
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              offers: {
                ...
                priceCurrency: "IRR",
                description:
                  "۲ ماه اشتراک رایگان برای شروع مدیریت هوشمند نوبت‌ها",
              },
              featureList: [
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          <div className="text-right z-10">
            ...
            <div className="inline-flex items-center gap-2 py-2 px-5 rounded-full bg-blue-50 text-blue-700 font-bold text-xs mb-8 border border-blue-100 shadow-sm">
              ...
              <h2 className="text-[11px] lg:text-xs">
            ...
            <p className="text-xl text-slate-600 mb-10 leading-relaxed max-w-2xl font-medium">
              ...
              کاهش کنسلی‌ها و صفحه رزرو اختصاصی مشتری بدون نیاز به نصب برنامه.
            </p>
