...
import { Gift, Zap, ArrowLeft, Sparkles, CheckCircle2, Clock } from 'lucide-react';
  ...
  dangerouslySetInnerHTML={{
    __html: JSON.stringify({
      ...
      "offers": {
        ...
        "price": "0",
        "priceCurrency": "IRR",
        "description": "۶۰ روز اشتراک کاملاً رایگان به همراه ۱۵۰ پیامک هدیه ماهانه بدون نیاز به ثبت کارت بانکی.",
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center relative z-10">
              ...
              <div className="text-right space-y-8">
                <div className="inline-flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/20 px-4 py-2 rounded-full text-emerald-400 shadow-inner">
                  ...
                  <span className="text-xs lg:text-sm font-black tracking-tight">فرصت محدود: عضویت در باشگاه مشتریان آنتایم</span>
                </div>
                ...
                <p className="text-slate-400 text-lg lg:text-xl font-medium leading-relaxed max-w-xl">
                  ما به کارایی <strong>نرم‌افزار نوبت‌دهی آنتایم</strong> ایمان داریم. به همین دلیل اجازه می‌دهیم <span className="text-white font-bold underline decoration-emerald-500 decoration-2">۶۰ روز کامل</span> از تمام امکانات حرفه‌ای استفاده کنید و هر ماه <span className="text-emerald-400 font-bold">۱۵۰ پیامک هدیه</span> برای یادآوری نوبت‌ها از ما بگیرید.
                </p>
                ...
                <div className="bg-white/5 backdrop-blur-2xl border border-white/10 p-10 lg:p-14 rounded-[3.5rem] w-full max-w-md text-center shadow-2xl relative transition-transform hover:scale-[1.02] duration-500">
                  ...
                  <div className="space-y-8">
                    <div className="space-y-3">
                      <div className="text-slate-400 font-bold text-sm tracking-widest uppercase">ارزش این پیشنهاد</div>
                      <div className="text-3xl font-black text-slate-500 line-through decoration-red-500/50">۱,۲۰۰,۰۰۰ تومان</div>
                      <div className="flex flex-col items-center">
                        <span className="text-7xl lg:text-8xl font-black text-white tracking-tighter">رایگان</span>
                        <span className="text-emerald-400 font-bold text-lg mt-2">برای ۶۰ روز اول</span>
                      </div>
                    </div>
  ...
  return (
    <div className="flex items-center gap-3 text-slate-300 group/item">
      <div className="bg-emerald-500/20 p-1 rounded-full group-hover/item:bg-emerald-500 transition-colors">
        <CheckCircle2 className="text-emerald-500 group-hover/item:text-slate-900 shrink-0" size={16} />
      </div>
