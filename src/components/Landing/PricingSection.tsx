      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-3xl lg:text-6xl font-black mb-6 text-slate-900 leading-tight">
            ...
            <span className="text-blue-600 font-extrabold bg-clip-text bg-linear-to-r from-blue-600 to-indigo-600">رشد کسب‌وکار شما</span>
          </h2>
          <p className="text-xl text-slate-600 max-w-3xl mx-auto font-medium leading-relaxed">
            بدون محدودیت فنی؛ تمام امکانات <strong>نرم‌افزار نوبت‌دهی آنتایم</strong> در همه پلن‌ها برای شما فعال است. فقط بر اساس نیاز پیامکی خود انتخاب کنید.
          </p>
        </div>
        ...
        {plansLoading ? (
          <div className="flex flex-col items-center py-32">
            ...
            <p className="mt-8 text-slate-500 font-black text-lg animate-pulse">در حال دریافت جدیدترین تعرفه‌ها...</p>
          </div>
        ) : (
              ...
              return (
                ...
                >
                  ...
                  <div className="mb-10 text-center">
                    <h3 className="text-2xl font-black text-slate-900 mb-6">{plan.title}</h3>
                    ...
                    {isFreeTrial ? (
                      <div className="bg-emerald-600 text-white p-8 rounded-[2.5rem] shadow-xl shadow-emerald-200/50 transform -rotate-1 group-hover:rotate-0 transition-transform">
                        <div className="text-4xl font-black mb-1 tracking-tighter">۲ ماه رایگان</div>
                        <div className="text-sm font-bold opacity-90 border-t border-white/20 mt-3 pt-3">۱۵۰ پیامک هدیه / ماهانه</div>
                      </div>
                    ) : (
                      <div className="flex flex-col items-center">
                        <div className="flex items-baseline gap-2">
                          ...
                          <span className="text-slate-500 text-sm font-bold">تومان / ماه</span>
                        </div>
                        {plan.free_sms_month > 0 && (
                          <div className="mt-4 text-emerald-600 text-[13px] font-black bg-emerald-50 px-4 py-2 rounded-2xl border border-emerald-100 inline-flex items-center gap-2">
                            ...
                            {plan.free_sms_month.toLocaleString('fa-IR')} پیامک رایگان ماهانه
                          </div>
                        )}
                      </div>
                    )}
                  ...
                  >
                    {isFreeTrial ? "فعالسازی هدیه ۲ ماهه" : "شروع اشتراک حرفه‌ای"}
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
              <div className="text-right">
                <div className="flex items-center gap-3 mb-6">
                   ...
                   <h3 className="text-3xl lg:text-4xl font-black text-white">نیاز به راهکار سازمانی دارید؟</h3>
                </div>
                <p className="text-slate-400 text-lg lg:text-xl font-medium max-w-2xl leading-relaxed">
                  اگر کلینیک، سالن زیبایی زنجیره‌ای یا مجموعه‌ای با بیش از <strong>۱۰ پرسنل</strong> دارید، ما برای شما پلن‌های شخصی‌سازی شده با تخفیف ویژه در نظر گرفته‌ایم.
                </p>
              </div>
              
              <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
                <Link href="tel:09981394832" className="flex-1 lg:flex-none flex items-center justify-center gap-3 bg-white text-slate-900 px-10 py-6 rounded-2xl font-black text-lg hover:shadow-2xl hover:bg-blue-50 transition-all active:scale-95">
                  <Phone size={22} />
                  مشاوره رایگان فروش
                </Link>
                <Link href="https://wa.me/09354502369" className="flex-1 lg:flex-none flex items-center justify-center gap-3 border border-slate-700 text-white px-10 py-6 rounded-2xl font-black text-lg hover:bg-slate-800 transition-all active:scale-95">
  ...
  return (
    <div className="flex items-center gap-3 group/item">
      <div className="bg-blue-50 rounded-full p-1.5 shrink-0 group-hover/item:bg-blue-600 transition-colors duration-300">
        <Check size={14} className="text-blue-600 group-hover/item:text-white" strokeWidth={4} />
      </div>
      <span className="text-slate-700 text-sm font-bold group-hover/item:text-slate-900 transition-colors">{label}</span>
    </div>
  );
}