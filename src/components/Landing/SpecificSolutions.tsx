import { Scissors, Stethoscope, Scale, Sparkles, Car, Clock, Check, Smartphone, MessageSquare } from 'lucide-react'
  ...
  const industries: Industry[] = [
    {
      ...
      description: "مدیریت لاین‌های مختلف و کاهش کنسلی نوبت‌های خدمات زیبایی با پیامک یادآوری.",
    },
    {
      icon: <Stethoscope size={24} />,
      title: "پزشکان و کلینیک‌ها",
      seoKeyword: "مدیریت نوبت مطب",
      description: "نظم بخشیدن به صف انتظار بیماران و ارسال خودکار اطلاعات نوبت بلافاصله پس از ثبت.",
    },
    {
      icon: <Scale size={24} />,
      title: "وکلا و دفاتر مشاوره",
      seoKeyword: "رزرو وقت مشاوره",
      description: "جلوگیری از تداخل جلسات و مدیریت زمان‌های خالی بدون نیاز به دفترچه کاغذی.",
    },
    {
      icon: <Car size={24} />,
      title: "کارواش و خدمات خودرو",
      seoKeyword: "نوبت دهی کارواش",
      description: "ثبت پلاک و نوع سرویس خودرو و اطلاع‌رسانی زمان حضور به مالک خودرو.",
    },
    {
      icon: <Sparkles size={24} />,
      title: "مراکز لیزر و ماساژ",
      seoKeyword: "مدیریت نوبت لیزر",
      description: "پیگیری مراجعات قبلی مشتری و یادآوری جلسات بعدی برای حفظ نظم مرکز.",
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-right mb-16">
          ...
          <p className="text-lg text-slate-600 max-w-3xl font-medium leading-relaxed">
            سامانه نوبت دهی آنتایم یک پنل مدیریت داخلی است. تمام نوبت‌ها توسط شما ثبت می‌شود و مشتری <strong>بدون نیاز به نصب هیچ اپلیکیشنی</strong>، تمام جزییات را از طریق پیامک و لینک اختصاصی دریافت می‌کند.
          </p>
        </div>
          ...
          <div className="order-2 lg:order-1">
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="p-8 bg-slate-50 rounded-4xl border border-slate-100 hover:bg-blue-50/50 transition-colors">
                ...
                <h3 className="font-black text-slate-900 mb-2 text-lg">ارسال پیامک نوبت دهی</h3>
                <p className="text-xs text-slate-500 leading-relaxed font-bold">تایید رزرو، یادآوری نوبت و اطلاع‌رسانی لغو به صورت کاملاً خودکار و هوشمند.</p>
              </div>
              <div className="p-8 bg-slate-50 rounded-4xl border border-slate-100 hover:bg-blue-50/50 transition-colors">
                <Smartphone className="text-blue-600 mb-4" />
                <h3 className="font-black text-slate-900 mb-2 text-lg">لینک رزرو نوبت آنلاین</h3>
                <p className="text-xs text-slate-500 leading-relaxed font-bold">صفحه نمایش جزییات نوبت با قابلیت تغییر زمان توسط مشتری جهت کاهش ۷۰ درصدی کنسلی‌ها.</p>
              </div>
            </div>
          </div>

          <div className="order-1 lg:order-2 space-y-8">
            <h3 className="text-2xl font-black text-slate-900">چرا اپلیکیشن نوبت دهی آنتایم برای کسب‌وکار شما؟</h3>
        ...
        <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-6 border-t border-slate-100 pt-16">
          {industries.map((item, index) => (
            <div key={index} className="p-6 text-center group hover:bg-slate-50 rounded-3xl transition-all duration-300">
