      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        <div className="text-right">
          ...
          <h2 className="text-3xl lg:text-5xl font-black text-white mb-8 leading-tight">
             <span className="text-blue-500 text-2xl lg:text-3xl block mb-2 font-bold">اتوماسیون پیامکی آنتایم؛</span>
            مشتری شما نیاز به نصب <br /> هیچ اپلیکیشنی ندارد!
          </h2>
          
          <p className="text-lg text-slate-400 mb-10 leading-relaxed font-medium">
            قدرت <strong>نرم‌افزار نوبت‌دهی آنلاین آنتایم</strong> در سادگی آن است. شما نوبت را در پنل مدیریت ثبت می‌کنید و سیستم تمام مراحل <strong>اطلاع‌رسانی و یادآوری پیامکی</strong> را به صورت خودکار انجام می‌دهد.
          </p>

          <div className="grid gap-4">
            {benefits.map((item, index) => (
              <div key={index} className="group bg-white/5 backdrop-blur-md p-6 rounded-3xl border border-white/10 hover:border-blue-500/50 transition-all duration-300">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="text-2xl font-black text-blue-500 tabular-nums">{item.stat}</div>
                </div>
          ...
          <div className="relative mx-auto w-full max-w-[380px] bg-slate-900 rounded-[3rem] border-12 border-slate-800 shadow-2xl overflow-hidden aspect-9/18">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-center gap-3 border-b border-white/5 pb-4">
                <Image src='/icons/icon-192.png' height={100} alt='اپلیکیشن نوبت دهی آنتایم' width={100} className="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold shadow-lg shadow-blue-600/40"/>
                <div>
              ...
              <div className="bg-blue-600 text-white p-4 rounded-2xl rounded-tr-none shadow-xl transform rotate-1">
                <div className="flex items-center gap-2 mb-2 opacity-90">
                  <CheckCircle size={14} />
                  <span className="text-[10px] font-bold">تایید رزرو نوبت آنلاین</span>
                </div>
              ...
              <div className="bg-slate-800 text-slate-200 p-4 rounded-2xl rounded-tr-none shadow-xl transform -rotate-1">
                <div className="flex items-center gap-2 mb-2 text-blue-400">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-tighter">یادآوری خودکار نوبت</span>
                </div>
              ...
              <div className="bg-white/5 border border-dashed border-white/20 p-5 rounded-2xl text-center">
                ...
                <p className="text-[10px] text-slate-400 font-bold leading-relaxed">
                  مشتری با کلیک بر روی لینک، مستقیماً وارد <span className="text-white">صفحه اختصاصی رزرو</span> می‌شود (بدون نیاز به نصب یا ثبت‌نام).
                </p>
              </div>
            </div>
          </div>
