      ...
      {isOpen && (
        <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4" dir="rtl">
          ...
          <motion.div
            ...
            className="relative bg-white dark:bg-[#1a1e26] border border-slate-200 dark:border-white/10 w-full max-w-md rounded-2xl p-6 shadow-xl dark:shadow-2xl max-h-[85vh] overflow-y-auto"
          >
            <div className="flex items-center justify-between mb-5 pb-3 border-b border-slate-200 dark:border-white/10">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-slate-800 dark:text-white">راهنمای مدیریت پرسنل</h2>
              </div>
              <button
                onClick={onClose}
                className="w-8 h-8 rounded-full bg-slate-100 dark:bg-white/5 hover:bg-slate-200 dark:hover:bg-white/10 flex items-center justify-center transition"
              >
            ...
            <div className="space-y-6">
              ...
              <div className="bg-slate-100 dark:bg-white/5 rounded-xl p-4">
                <h3 className="text-md font-bold text-emerald-600 dark:text-emerald-400 mb-3 flex items-center gap-2">
                  <Plus className="w-4 h-4" />
                  نحوه اضافه کردن پرسنل
                </h3>
                <ol className="space-y-2 text-sm text-slate-600 dark:text-gray-300 list-decimal list-inside mr-2">
                  <li>روی دکمه <span className="text-emerald-600 dark:text-emerald-400">"+"</span> در هدر کلیک کنید</li>
                  ...
                  <li>روی دکمه <span className="text-emerald-600 dark:text-emerald-400">"افزودن پرسنل"</span> کلیک کنید</li>
                </ol>
              </div>
              ...
              <div className="bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/30 rounded-xl p-4">
                ...
                <div className="bg-slate-100 dark:bg-[#0f1115] rounded-xl p-3 flex items-center justify-between gap-2">
                  <code className="text-emerald-700 dark:text-emerald-400 text-sm break-all flex-1 text-center">
                    {LOGIN_URL}
                  </code>
                  <button
                    onClick={handleCopyLink}
                    className="p-2 rounded-lg bg-emerald-100 dark:bg-emerald-500/20 hover:bg-emerald-200 dark:hover:bg-emerald-500/30 transition flex items-center gap-1 shrink-0"
                    title="کپی لینک"
                  >
                    {copied ? (
                ...
                <div className="space-y-3">
                  <div className="bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/30 rounded-xl p-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-bold text-blue-700 dark:text-blue-400">هماهنگ با اصلی (Synced)</span>
                    </div>
                  ...
                  <div className="bg-purple-50 dark:bg-purple-500/10 border border-purple-200 dark:border-purple-500/30 rounded-xl p-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-bold text-purple-700 dark:text-purple-400">مستقل (Independent)</span>
                    </div>
                    <p className="text-sm text-slate-600 dark:text-gray-300">
              ...
              <div>
                ...
                <div className="bg-slate-100 dark:bg-white/5 rounded-xl p-4 space-y-2">
                  <p className="text-sm text-slate-600 dark:text-gray-300">
                    هر پرسنل دارای یک <span className="text-emerald-600 dark:text-emerald-400">اعتبار پیامک جداگانه</span> است.
                  </p>
                  <ul className="text-sm text-slate-600 dark:text-gray-300 list-disc list-inside mr-4 space-y-1">
                    <li>پیامک‌های ارسالی توسط پرسنل از <span className="text-emerald-600 dark:text-emerald-400">اعتبار خودش</span> کسر می‌شود</li>
              ...
              <div>
                ...
                <div className="bg-slate-100 dark:bg-white/5 rounded-xl p-4 space-y-2">
                  <ul className="text-sm text-slate-600 dark:text-gray-300 list-disc list-inside mr-4 space-y-1">
                    <li><span className="text-emerald-600 dark:text-emerald-400">دسترسی به همه مشتریان</span>: پرسنل می‌تواند لیست تمام مشتریان کسب‌وکار را ببیند</li>
                    <li><span className="text-emerald-600 dark:text-emerald-400">فقط مشتریان خود</span>: پرسنل فقط مشتریانی که خودش برایشان نوبت ثبت کرده را می‌بیند</li>
                  </ul>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="bg-slate-100 dark:bg-white/5 rounded-xl p-4">
                  <p className="text-sm text-slate-600 dark:text-gray-300">
                    می‌توانید تعیین کنید هر پرسنل فقط به <span className="text-emerald-600 dark:text-emerald-400">خدمات خاصی</span> دسترسی داشته باشد.<br />
              ...
              <div>
                ...
                <div className="bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/30 rounded-xl p-4">
                  <ul className="text-sm text-slate-600 dark:text-gray-300 list-disc list-inside mr-4 space-y-1">
                    <li>اگر پرسنل <span className="text-red-600 dark:text-red-400">نوبت فعال نداشته باشد</span>، به راحتی حذف می‌شود</li>
                    <li>اگر نوبت فعال داشته باشد، ابتدا باید نوبت‌ها را لغو کنید</li>
                    <li>با <span className="text-red-600 dark:text-red-400">حذف اجباری</span>، تمام نوبت‌های فعال پرسنل به صورت خودکار لغو می‌شوند</li>
      ...
      <div className="max-w-2xl mx-auto p-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={onHelpClick}
              className="p-2.5 flex items-center space-x-2 rounded-xl bg-slate-100 dark:bg-white/10 hover:bg-slate-200 dark:hover:bg-white/20 transition"
              title="راهنما"
            >
              <HelpCircle className="w-5 h-5 text-slate-600 dark:text-gray-300" /> 
              <span className="text-slate-700 dark:text-gray-300">راهنما</span>
            </button>

            <button
              onClick={handleRefreshClick}
              disabled={isLoading || isForcingSpin}
              className="p-2.5 rounded-xl bg-slate-100 dark:bg-white/10 hover:bg-slate-200 dark:hover:bg-white/20 transition disabled:opacity-50"
            >
              <RefreshCw
...
export default function StaffsPage() {
  ...
  return (
    <div className="min-h-screen overflow-auto max-w-md m-auto bg-slate-50 dark:bg-[#1a1e26] transition-colors">
      <Toaster
        position="top-center"
        toastOptions={{
          duration: 4000,
