      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            animate="visible"
            exit="exit"
            className="relative w-full max-w-[95%] sm:max-w-lg bg-gradient-to-br from-[#1a1e26] to-[#151920] border border-white/10 rounded-2xl sm:rounded-[2rem] shadow-2xl flex flex-col h-[90vh] sm:h-[85vh] overflow-hidden"
          >
            {/* Header - Fixed */}
            <div className="flex items-center justify-between p-4 sm:p-5 border-b border-white/10 bg-white/5 backdrop-blur-sm shrink-0">
              ...
              <button
                onClick={onClose}
                className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:bg-white/10 hover:text-white transition-all duration-200"
              >
            ...
            {selectedSubType !== "all" && (
              ...
              >
                {selectedSubType === "cancel" ? (
                  <AlertTriangle size={14} className="text-red-400 sm:size-4" />
                ) : (
                  <Bell size={14} className="text-emerald-400 sm:size-4" />
                )}
                <span
            ...
            {availableCategories.length > 0 && (
              <div className="border-b border-white/10 bg-white/2 shrink-0">
              ...
              {isLoading ? (
                ...
                <div className="text-center py-16 sm:py-20">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-white/5 flex items-center justify-center mx-auto mb-3 sm:mb-4">
                    <AlertCircle size={20} className="text-gray-600 sm:size-6" />
                  </div>
                  <p className="text-xs sm:text-sm text-gray-500">
                ...
                <>
                  {currentTemplates.map((template: any, index: number) => (
                    <motion.button
                      ...
                      className="w-full text-right p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-gradient-to-br from-white/5 to-transparent border border-white/10 hover:border-emerald-500/40 transition-all duration-300 group hover:shadow-lg hover:shadow-emerald-500/10"
                    >
                      <div className="flex flex-wrap justify-between items-start gap-2 mb-2 sm:mb-3">
                        <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
                          <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-lg bg-emerald-500/10 flex items-center justify-center">
                            <FileText size={10} className="text-emerald-400 sm:size-3" />
                          </div>
                          <span className="text-[10px] sm:text-xs font-bold text-emerald-400 px-1.5 py-0.5 sm:px-2 bg-emerald-500/10 rounded-lg">
                            {template.title}
                          </span>
                          {template.sub_type === "cancel" && (
                            <span className="text-red-400 text-[8px] sm:text-[10px] font-medium bg-red-500/10 px-1.5 py-0.5 rounded-full flex items-center gap-0.5 sm:gap-1">
                              <AlertTriangle size={8} className="sm:size-2.5" />
                              کنسلی
                            </span>
                          )}
                          {template.job_id && template.job_name && (
                            <span className="text-cyan-400 text-[8px] sm:text-[10px] font-medium bg-cyan-500/10 px-1.5 py-0.5 rounded-full flex items-center gap-0.5 sm:gap-1">
                        ...
                        <span className="text-[8px] sm:text-[10px] text-gray-500 font-medium px-1.5 py-0.5 sm:px-2 bg-white/5 rounded-full">
                          {template.message_count ||
                      ...
                      <div className="relative">
                        <div className="pr-2 sm:pr-4">
                          <div className="text-[10px] sm:text-sm text-gray-300 leading-relaxed line-clamp-2 sm:line-clamp-3">
                      ...
                      <div className="mt-2 sm:mt-3 flex justify-end">
                        <span className="text-[8px] sm:text-[10px] text-emerald-500/50 group-hover:text-emerald-400 transition-colors">
                          کلیک برای انتخاب ←
                        </span>
                      </div>
                    </motion.button>
                  ...
                  <Link
                    ...
                    className="text-[10px] sm:text-xs w-full border border-white/10 py-2.5 sm:py-3 text-gray-400 text-center block rounded-xl sm:rounded-2xl hover:bg-white/5 transition-all mt-2"
                  >
                    پیشنهاد متن پیامک
                  </Link>
                </>
        ...
        {isOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative w-full max-w-[95%] sm:max-w-md bg-gradient-to-br from-[#1a1e26] to-[#151920] rounded-2xl sm:rounded-[2rem] border border-white/10 shadow-2xl flex flex-col h-[90vh] sm:h-[85vh] overflow-hidden"
            >
              {/* Header - Fixed */}
              <div className="p-4 sm:p-5 border-b border-white/10 flex items-center justify-between bg-gradient-to-r from-white/5 to-transparent shrink-0 backdrop-blur-sm">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div>
                    <h3 className="text-sm sm:text-lg font-bold bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
                      {title}
                    </h3>
                ...
                <button
                  onClick={onClose}
                  className="w-8 h-8 sm:w-10 sm:h-10 p-1.5 sm:p-2 hover:bg-white/10 rounded-full text-gray-400 hover:text-white transition-all duration-200"
                >
              ...
              <div className="flex-1 overflow-y-auto custom-scrollbar">
                <div className="p-4 sm:p-5 space-y-4 sm:space-y-5">
                  ...
                  <div className="shrink-0">
                    <label className="block text-[10px] sm:text-xs text-gray-500 mb-1.5 sm:mb-2 mr-1">
                      نوع پیام همگانی
                    </label>
                    ...
                    <p className="text-[8px] sm:text-[10px] text-gray-500 mt-1.5 sm:mt-2 text-center">
                      {selectedMessageType === "cancel"
                    ...
                    <AnimatePresence mode="wait">
                      {!selectedTemplate ? (
                        <motion.button
                          ...
                          className="w-full bg-gradient-to-r from-white/5 to-transparent border border-dashed border-white/20 rounded-xl sm:rounded-2xl p-3 sm:p-4 flex items-center justify-between group hover:border-emerald-500/40 hover:bg-white/10 transition-all duration-300"
                        >
                          <div className="flex items-center gap-2 sm:gap-3">
                            <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-xl bg-emerald-500/10 flex items-center justify-center group-hover:bg-emerald-500/20 transition-all">
                              <MessageSquare
                                size={14}
                                className="text-gray-500 group-hover:text-emerald-400 transition-colors sm:size-4"
                              />
                            </div>
                          ...
                          <ChevronLeft
                            size={14}
                            className="text-gray-600 group-hover:text-emerald-400 group-hover:-translate-x-1 transition-all duration-200 sm:size-4"
                          />
                        </motion.button>
                      ) : (
                        <motion.div
                        ...
                        >
                          ...
                          <div className="flex justify-between items-center mb-2 sm:mb-3">
                            <div className="flex items-center gap-1.5 sm:gap-2">
                              <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-lg bg-emerald-500/20 flex items-center justify-center">
                                <FileText
                                  size={10}
                                  className="text-emerald-400 sm:size-3"
                                />
                              </div>
                              <span className="text-[9px] sm:text-[11px] font-black text-emerald-400 uppercase tracking-tighter">
                                الگوی انتخاب شده
                              </span>
                            </div>
                            <button
                              onClick={() => setSelectedTemplate(null)}
                              className="text-red-400 p-1 hover:bg-red-500/10 rounded-lg transition-all duration-200"
                            >
                              <X size={12} className="sm:size-3.5" />
                            </button>
                          </div>

                          <div className="flex justify-between text-[8px] sm:text-[10px] text-gray-500 mb-2 sm:mb-3 pb-1.5 sm:pb-2 border-b border-white/10">
                          ...
                          <div className="bg-black/20 rounded-lg sm:rounded-xl p-2 sm:p-3 max-h-28 sm:max-h-40 overflow-y-auto">
                            <div className="text-[9px] sm:text-[11px] text-gray-300 leading-relaxed">
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    <div className="flex justify-between items-center px-1">
                      ...
                      <button
                        ...
                        className="text-emerald-400 text-[9px] sm:text-[11px] hover:underline font-bold transition-all hover:text-emerald-300"
                      >
                        {selectedIds.length === recipients.length
                          ? "لغو همه"
                          : "انتخاب همه"}
                        ...
                        >
                          <div className="flex items-center gap-2 sm:gap-3 flex-1">
                            ...
                            <div className="flex-1">
                              ...
                              {item.details && (
                                <p className="text-[8px] sm:text-[10px] text-gray-500 mt-0.5 truncate max-w-[150px] sm:max-w-[200px]">
                                  {item.details}
                                </p>
                              )}
                            </div>
              ...
              {/* Footer - Fixed */}
              <div className="p-3 sm:p-5 border-t border-white/10 bg-gradient-to-t from-[#1a1e26] to-transparent shrink-0">
                <motion.button
                  whileTap={{ scale: 0.97 }}
                  ...
                  className="w-full py-3 sm:py-4 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 disabled:from-gray-700 disabled:to-gray-700 disabled:opacity-50 rounded-xl sm:rounded-2xl font-black text-white flex items-center justify-center gap-2 sm:gap-3 shadow-xl shadow-emerald-500/20 transition-all duration-300 text-xs sm:text-base"
                >
        ...
        {showConfirmStep && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative w-full max-w-[90%] sm:max-w-md bg-gradient-to-br from-[#1a1e26] to-[#151920] rounded-xl sm:rounded-2xl border border-white/10 shadow-2xl overflow-hidden"
            >
              <div className="p-4 sm:p-6 text-center">
                ...
                <h4 className="text-base sm:text-xl font-black text-white mb-1 sm:mb-2">
                  تأیید نهایی ارسال
                </h4>

                <p className="text-gray-400 text-[11px] sm:text-sm mb-4 sm:mb-6 leading-relaxed">
                  {selectedMessageType === "cancel"
                    ? "در حال ارسال پیامک کنسلی نوبت به صورت گروهی هستید."
                    : "در حال ارسال پیامک اطلاع‌رسانی به صورت گروهی هستید."}
                </p>

                <div className="bg-white/5 rounded-xl sm:rounded-2xl p-3 sm:p-4 mb-4 sm:mb-6 space-y-2 sm:space-y-3">
                  <div className="flex justify-between items-center text-[11px] sm:text-sm">
                    <span className="text-gray-400">تعداد گیرندگان:</span>
                    <div className="flex items-center gap-1.5 sm:gap-2">
                      <Users size={12} className="text-emerald-400 sm:size-3.5" />
                ...
                <div className="flex gap-2 sm:gap-3">
                  <button
                    onClick={() => setShowConfirmStep(false)}
                    className="flex-1 py-2.5 sm:py-3 bg-white/10 hover:bg-white/15 rounded-lg sm:rounded-xl font-bold text-gray-400 hover:text-white transition-all duration-200 text-[11px] sm:text-sm"
                  >
                    بازگشت
                  </button>
                  <button
        ...
        {showBusinessModal && (
          ...
          >
            ...
            <motion.div
              ...
              animate="visible"
              exit="exit"
              className="relative w-full max-w-[90%] sm:max-w-sm bg-gradient-to-br from-[#1e232d] to-[#161a22] rounded-2xl sm:rounded-3xl border border-emerald-500/30 p-5 sm:p-6 shadow-2xl"
            >
              ...
              <h4 className="text-base sm:text-xl font-bold text-white mb-1 sm:mb-2 text-center">
                تکمیل اطلاعات بیزنس
              </h4>

              <p className="text-[10px] sm:text-xs text-gray-500 mb-4 sm:mb-6 text-center">
                برای ارسال پیامک، وارد کردن نام و آدرس الزامی است.
              </p>

              <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                <div className="relative group">
                  <div className="absolute right-3 sm:right-4 top-1/2 -translate-y-1/2 text-gray-500 group-hover:text-emerald-400 transition-colors">
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-xl sm:rounded-2xl py-3 sm:py-4 pr-9 sm:pr-12 pl-3 sm:pl-4 text-right text-white outline-none focus:border-emerald-500 focus:bg-white/10 font-bold transition-all duration-200 text-xs sm:text-sm"
                    placeholder="نام بیزنس (مثلاً: سالن مریم)"
                  />
                </div>

                <div className="relative group">
                  <div className="absolute right-3 sm:right-4 top-3 sm:top-5 text-gray-500 group-hover:text-emerald-400 transition-colors">
                  ...
                  <textarea
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-xl sm:rounded-2xl py-3 sm:py-4 pr-9 sm:pr-12 pl-3 sm:pl-4 text-right text-white outline-none focus:border-emerald-500 focus:bg-white/10 font-bold transition-all duration-200 text-xs sm:text-sm resize-none"
              ...
              <div className="flex gap-2 sm:gap-3">
                <button
                  onClick={() => setShowBusinessModal(false)}
                  className="flex-1 py-2.5 sm:py-4 text-gray-500 font-bold hover:text-white transition-colors duration-200 text-[11px] sm:text-sm"
                >
                  لغو
                </button>
                <button
