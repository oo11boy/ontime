...
// تابع پیش‌نمایش پیامک با جایگزینی متغیرها
      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl bg-gradient-to-br from-[#1a1e26] to-[#151920] border border-white/10 rounded-[2rem] shadow-2xl flex flex-col h-[85vh] overflow-hidden"
          >
            {/* Header - Fixed */}
            <div className="flex items-center justify-between p-5 border-b border-white/10 bg-white/5 backdrop-blur-sm shrink-0">
            ...
            {/* Search Bar - Fixed */}
            <div className="p-4 border-b border-white/10 bg-white/2 shrink-0">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl py-3 pr-10 pl-4 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-red-500/50 transition-all"
                />
              </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3 custom-scrollbar">
              {isLoading ? (
                <div className="flex flex-col items-center justify-center py-20">
                  ...
                  <p className="text-gray-400 mt-4 text-sm">در حال بارگذاری الگوها...</p>
                </div>
                  ...
                  >
                    <div
                      className={`p-4 rounded-xl border transition-all ${
                        selectedTemplateId === template.id
                          ? "bg-gradient-to-br from-red-500/15 to-red-500/5 border-red-500/40 shadow-lg shadow-red-500/10"
                          ...
                          <div className="text-right">
                            ...
                            {template.sub_type === "cancel" && (
                              <div className="flex items-center gap-1 mt-1">
                                ...
                                <span className="text-[9px] text-red-400">الگوی کنسلی</span>
                              </div>
                            )}
                          </div>
                        </div>
                        <span className="text-[9px] text-gray-500 bg-white/5 px-2 py-1 rounded-full">
