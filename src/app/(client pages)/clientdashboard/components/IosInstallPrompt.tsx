  ...
  return (
    <div className="fixed bottom-24 left-4 right-4 z-50 animate-bounce-in">
      <div className="bg-white rounded-2xl p-4 shadow-2xl relative border-2 border-emerald-500">
        ...
        <div className="flex flex-col gap-3 text-right" dir="rtl">
          ...
          <div className="flex items-center gap-2 text-gray-600 text-xs">
            <span className="bg-gray-100 p-1 rounded">
              1. دکمه <Share size={18} className="inline text-blue-500" />{" "}
              (Share) را در نوار پایین بزنید.
            </span>
          </div>
          ...
          <div className="flex items-center gap-2 text-gray-600 text-xs">
            <span className="bg-gray-100 p-1 rounded">
              2. گزینه 
              <PlusSquare size={18} className="inline" />
               (Add to HomeScreen)
               را انتخاب کنید.
            </span>
          </div>
        ...
        <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 w-0 h-0 border-l-12 border-l-transparent border-r-12 border-r-transparent border-t-15 border-t-white"></div>
      </div>
    </div>
  );
}
