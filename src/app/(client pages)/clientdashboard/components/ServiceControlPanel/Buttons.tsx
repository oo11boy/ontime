...
export default function AddAppointmentButton() {
  ...
  <Link href="../clientdashboard/bookingsubmit" passHref>
      <motion.button
        ...
        "
      >
        {/* افکت شاین متحرک (مثل اپ‌های پریمیوم) */}
        <motion.div
        ...
        {/* آیکون اصلی با چرخش و پالس */}
        <motion.div
   
    
          className="relative"
        >
          <Plus className="w-6 h-6 sm:w-12 sm:h-12 drop-shadow-lg" strokeWidth={3} />
  ...
  >
    افزودن نوبت جدید
        ...
        >
          <Sparkles className="w-7 h-7 text-yellow-400 drop-shadow-md" fill="currentColor" />
        </motion.div>

        {/* موج صوتی دایره‌ای موقع هاور (خیلی خفن!) */}
        <motion.div
