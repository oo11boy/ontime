      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10">
        <div className="order-2 lg:order-1 text-right">
          <div className="inline-flex items-center gap-2 py-2 px-5 rounded-2xl bg-rose-500/10 border border-rose-500/20 text-rose-400 text-xs font-black mb-8">
            <BellRing size={14} />
            سیستم پیامک یادآوری نوبت ترمیم و کاشت ناخن
          </div>
          
          {/* H2 بهینه شده برای سئو - کاملاً متفاوت از صفحه آرایشگاه */}
          <h2 className="text-4xl lg:text-5xl font-black mb-8 leading-[1.2]">
            <span className="text-rose-500">پیامک یادآوری خودکار</span>
            <br />
            نوبت ترمیم و کاشت ناخن
          </h2>
          
          <p className="text-slate-400 text-lg mb-10 leading-relaxed font-medium">
            بزرگترین چالش ناخن‌کارها، <strong className="text-white">فراموشی نوبت ترمیم توسط مشتری</strong> است. آنتایم با ارسال <strong className="text-rose-400">پیامک تایید نوبت کاشت و یادآوری هوشمند ترمیم</strong>، جای خالی مشتری را در سالن شما پر می‌کند. مشتری از طریق لینک اختصاصی، تمام جزئیات رزرو خود را مدیریت می‌کند.
          </p>
          
          {/* کلمات کلیدی مخفی برای سئو */}
          <p className="text-slate-500 text-xs mb-6 hidden md:block">
            ★ کاهش ۸۰ درصدی کنسلی نوبت ترمیم ★ افزایش رضایت مشتریان کاشت ناخن ★ مدیریت آنلاین نوبت بدون دخالت ناخن‌کار ★
          </p>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-[2rem] border border-slate-700 flex items-start gap-4 hover:border-rose-500/50 transition-colors">
              ...
              <div>
                <p className="font-black text-sm text-slate-100">یادآوری خودکار نوبت ترمیم</p>
                <p className="text-[11px] text-slate-500 mt-1 font-bold">ارسال پیامک ۲۴ ساعت قبل از موعد ترمیم</p>
              </div>
            </div>
            <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-[2rem] border border-slate-700 flex items-start gap-4 hover:border-rose-500/50 transition-colors">
              <div className="p-3 bg-rose-500/20 rounded-2xl text-rose-500"><Link2 size={24} /></div>
              <div>
                <p className="font-black text-sm text-slate-100">لینک اختصاصی مدیریت نوبت</p>
                <p className="text-[11px] text-slate-500 mt-1 font-bold">مشاهده جزئیات کاشت و ترمیم توسط مشتری</p>
              </div>
            </div>
          </div>

          {/* مزیت اضافی برای سئو */}
          <div className="mt-8 p-4 bg-rose-500/10 rounded-2xl border border-rose-500/20 text-center">
            <p className="text-sm font-bold">
              ✨ <span className="text-rose-400">۲ هفته رایگان</span> شامل ۵۰ پیامک یادآوری ترمیم ✨
            </p>
          </div>
        </div>
        ...
        <div className="relative order-1 lg:order-2">
          ...
          <div className="bg-white text-slate-900 p-8 rounded-[3rem] shadow-[0_40px_80px_-15px_rgba(225,29,72,0.3)] relative z-10 -rotate-2 hover:rotate-0 transition-all duration-700 max-w-sm mx-auto border-4 border-slate-800">
            <div className="flex items-center justify-between mb-6 border-b pb-4 border-slate-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-black text-slate-800 text-sm">تایید رزرو کاشت ناخن</p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <p className="text-[13px] font-bold leading-relaxed text-slate-700">
                خانم سمیرا عزیز، نوبت شما برای <span className="text-rose-600">ترمیم و کاشت ناخن</span> در تاریخ ۱۵ بهمن ساعت ۱۶:۰۰ ثبت شد.
              </p>
              <div className="bg-rose-50 p-4 rounded-2xl border border-rose-100">
                <p className="text-[10px] text-rose-600 font-black mb-2 flex items-center gap-1">
                  لینک مدیریت نوبت کاشت ناخن شما:
                </p>
                <p className="text-rose-700 font-black text-[12px] break-all tracking-tight">
                  ontimeapp.ir/c/nail-458k
                </p>
              </div>
              <div className="flex items-center gap-2 text-[10px] text-slate-400 font-bold">
                <ShieldCheck size={12} className="text-emerald-500" />
                لغو یا تغییر نوبت کاشت و ترمیم فقط تا ۲۴ ساعت قبل امکان‌پذیر است.
              </div>
            </div>
          </div>
          ...
          <div className="absolute -bottom-10 right-0 w-32 h-32 bg-rose-400 rounded-full blur-[80px] opacity-20"></div>
        </div>
      </div>
    </section>
  );
